...
public class WalkToGoalEnvironment {
    ...
    public WalkToGoalEnvironment(ExperimentConfig args) {
        this.args = args;
    ...
    public Observation getObservation() {
        ...
        ///  THIS GOT REPLACED and since its no longer used, I just commented it out for now

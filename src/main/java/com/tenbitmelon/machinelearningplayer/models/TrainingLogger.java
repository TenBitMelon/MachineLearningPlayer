...
public class TrainingLogger {
    ...
    public TrainingLogger(ExperimentConfig args) {
        ...
        try {
            ...
            String[] columns = new String[]{
                ...
                // "torch_allocated_bytes_peak",
                "torch_reserved_bytes_current",
                // "torch_reserved_bytes_peak",
                "torch_active_bytes_current",
                // "torch_active_bytes_peak",
                // "torch_inactive_split_bytes_current",
                // "torch_inactive_split_bytes_peak",
                ...
                "java_heap_used"
                // "os_available_physical_bytes",
                // "os_total_physical_bytes",
    ...
    public void logStep(
        ...
        double totalRewards,
        int bowSelectedSteps,
        int bowDrawingSteps,
        int bowFullyDrawnSteps,
        int shieldUsingSteps,
        // long gpuMemUsedNvidia,
        // long gpuMemTotalNvidia,
        // int gpuUtilNvidia,
        // int gpuTempNvidia,

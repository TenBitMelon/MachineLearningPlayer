...
public class EntityPlayerActionPack {
    ...
    static HitResult getTarget(Agent player) {
    ...
    public void setVelocity(double xa, double ya, double za) {
    ...
    public enum ActionType {
        USE(true) {
            ...
            @Override
            void inactiveTick(Agent player, Action action) {
                EntityPlayerActionPack ap = player.getActionPack();
        ...
        void start(Agent player, Action action) {}

        abstract boolean execute(Agent player, Action action);

        void inactiveTick(Agent player, Action action) {}

        void stop(Agent player, Action action) {
